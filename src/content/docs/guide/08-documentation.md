...
> [!TIP]
> **สำหรับ Revit 2026: ถ้าต้องส่ง Schedule ไปทำงานต่อในสเปรดชีต ให้มอง `CSV` เป็นตัวเลือกหลักก่อน**
> ในงานทั่วไปลำดับที่ใช้งานได้จริงมักเป็น:
> - `CSV` หรือไฟล์ข้อมูลจาก Revit สำหรับส่งออกข้อมูลดิบ
> - `XLSX` เมื่อต้องจัดรูปแบบ คำนวณเพิ่ม หรือรวมรายงานภายนอก
> วิธีนี้ลดขั้นตอนแปลงไฟล์และเข้ากับ workflow ปัจจุบันมากกว่าใช้ TXT อย่างเดียว
