...
Family ขั้นสูงช่วยให้ชิ้นส่วนยืดหยุ่น ส่วน Dynamo ขั้นสูงช่วยให้ workflow ทั้งทีมเร็วขึ้น บทนี้จึงเป็นหัวใจของการยกระดับจาก "ผู้ใช้ Revit" ไปเป็น "คนออกแบบระบบงาน Revit" ครับ
