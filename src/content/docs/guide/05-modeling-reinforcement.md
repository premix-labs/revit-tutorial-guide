...
| --- | --- | --- | --- |
| เสา | `Propagate Rebar` | หน้าตัดเสา, cover และคานรอบเสาใกล้เคียงกันจริง | มีคานตัดต่างกัน, มี warning นอก host, หรือ orientation ไม่เหมือนกัน |
...
| ฐานราก | `Propagate Rebar` | footing type, cover และ host condition ใกล้เคียงกันจริง | มี footing ต่าง type, ต่าง cover หรือมีองค์ประกอบรอบข้างต่างกัน |
...
### ขั้นที่ 3: คัดลอกเหล็กไปยังเสาต้นอื่น (Propagate Rebar หรือ Copy)
...
**วิธีที่ 1: ใช้ Propagate Rebar (ทางเลือกสำหรับกรณีที่ host ใกล้เคียงกันจริง)**
...
2. ถ้าเลือกพื้น (slab) อยู่ ให้มองหา **ปุ่ม `Area Reinforcement` ใน Contextual Tab ของ host ที่เลือก** ก่อน
   ...
   - _ถ้าไม่เห็นปุ่ม ให้ใช้เส้นทางที่ปลอดภัยสุดคือ **Structure > Rebar > Area Reinforcement**_
