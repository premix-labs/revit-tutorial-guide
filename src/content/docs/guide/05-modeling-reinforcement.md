...
หลายครั้งหลังคัดลอกเหล็กเสร็จ โปรแกรมอาจแสดงคำเตือนสีเหลืองว่า _"Rebar is placed completely outside of its host"_ (โดยเฉพาะถ้าใช้วิธี `Propagate Rebar`) ทั้งที่เหล็กยังอยู่ในเสาครบถ้วน สาเหตุคือโปรแกรมอาจไวต่อการตรวจจับบริเวณรอยต่อระหว่างเสากับพื้น วิธีตรวจยืนยันที่ปลอดภัยกว่าคือเปิดดูในมุมมอง 3D หรือ Section เพิ่มเติมครับ:
