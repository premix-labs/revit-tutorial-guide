...
> [!TIP]
> **ไม่มี ETABS ก็เรียนได้!** ค่าขนาดหน้าตัดและเหล็กเสริมทั้งหมดถูกเตรียมไว้ให้ในตารางของแต่ละบทแล้ว คุณสามารถใช้ค่าเหล่านี้ฝึกสร้างโมเดลได้ทันที และข้ามบทที่ 09 (Interoperability) ไปก่อนได้ครับ
...
2.  ดาวน์โหลด **Revit** (เวอร์ชันล่าสุด เช่น Revit 2026)
...
| 04  | Modeling Concrete | ขึ้นเสา/คาน/พื้น/ทางลาด + ฐานรากตัวอย่าง (เส้นทางหลักใช้ Isolated Foundation) | 🟢 เริ่มต้น |
